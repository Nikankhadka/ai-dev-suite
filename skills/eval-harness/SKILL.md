...
- Defining pass/fail criteria for AI agent task completion
...
```
Creates eval definition file at `.opencode/evals/feature-name.md` (or `.claude/evals/` for Claude compatibility)
...
```
(Or `.claude/` directory for Claude Code compatibility)
...
- `.opencode/evals/<feature>.md` definition (or `.claude/evals/` for Claude)
- `.opencode/evals/<feature>.log` run history (or `.claude/evals/` for Claude)
