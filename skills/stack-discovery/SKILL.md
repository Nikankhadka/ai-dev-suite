...
## Step 1: CONTEXT.md / AGENTS.md wins

Read `AGENTS.md` or `CONTEXT.md` at the project root if either exists. Their stack and commands sections are the source of truth - use them and skip the remaining steps. If neither exists, continue to Step 2 for a one-off answer.
